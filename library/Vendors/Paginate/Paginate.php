...
class Paginate
{
    ...
    static public function createCountQuery(Query $query)
    {
        ...
        $countQuery->setHint(Query::HINT_CUSTOM_TREE_WALKERS, array('Vendors\Paginate\CountWalker'));
    ...
    static public function createLimitSubQuery(Query $query, $offset, $itemCountPerPage)
    {
        ...
        $subQuery->setHint(Query::HINT_CUSTOM_TREE_WALKERS, array('Vendors\Paginate\LimitSubqueryWalker'))
    ...
    static public function createWhereInQuery(Query $query, array $ids, $namespace = 'pgid')
    {
        ...
        if (count($ids) > 0) {
            ...
            $whereInQuery->setHint(Query::HINT_CUSTOM_TREE_WALKERS, array('Vendors\Paginate\WhereInWalker'));
