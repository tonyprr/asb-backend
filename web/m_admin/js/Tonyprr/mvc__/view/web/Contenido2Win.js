...
Ext.define('Tonyprr.mvc.view.web.Contenido2Win', {
	extend 			: "Ext.Panel",
        alias                   : 'widget.winContenido2s',
        itemId: 'winContenido2s',
        title   : "Mind Break",
        autoHeight: true,
        autoWidth: true,
//        region : 'north',
...
//		this.buttons = this.createButtons();
		this.callParent();
                meContenido2Win = this;
                storeContenido2Lang = Ext.create('Tonyprr.mvc.store.web.ContentLanguage');
                
                meContenido2Win.down('panel[itemId="panelContenido2Language"]').add(
                                    {
                                        xtype : 'grid',
                                        itemId:'gridContenido2Language',
                                        frame:true,
                                        columnLines : true,
                                        autoScroll:true,
                                        store : storeContenido2Lang,
                                        border:false,
                                        columns : [
                                            {
                                                xtype:'actioncolumn', 
                                                ...
                                                items: [
                                                    {
                                                        ...
                                                        handler: function(grid, rowIndex, colIndex) {
                                                            ...
                                                            grid.up('panel[itemId="panelContenido2Language"]').down(('form[itemId="formContenido2Language"]')).loadRecord(model);
                                                        }
                                                    }
                                                ]
                                            },
                                            ...
                                            {dataIndex: 'descripcion',header : 'Titulo',width: 270}
                                        ]
                                    }
                                );
