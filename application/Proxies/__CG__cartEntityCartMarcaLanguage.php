 ...
 */
class CartMarcaLanguage extends \cart\Entity\CartMarcaLanguage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getIdMarcaLanguage()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["idMarcaLanguage"];
        }
        $this->__load();
        return parent::getIdMarcaLanguage();
    }
    ...
    {
        return array('__isInitialized__', 'idMarcaLanguage', 'detalle', 'adjunto', 'language', 'marca');
    }
