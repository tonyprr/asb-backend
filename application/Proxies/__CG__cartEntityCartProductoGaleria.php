 ...
 */
class CartProductoGaleria extends \cart\Entity\CartProductoGaleria implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'idcontgale', 'ordenGale', 'imagenGale', 'fecharegGale', 'languages', 'producto');
    }
