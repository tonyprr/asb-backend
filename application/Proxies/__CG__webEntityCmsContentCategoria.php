 ...
 */
class CmsContentCategoria extends \web\Entity\CmsContentCategoria implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setEstadoCate($estadoCate);
    }

    public function getEstadoCate()
    {
        $this->__load();
        return parent::getEstadoCate();
    }
    ...
    {
        return array('__isInitialized__', 'idcontcate', 'nivelCate', 'imagenCate', 'ordenCate', 'estadoCate', 'fechamodfCate', 'fecharegCate', 'languages', 'contcatePadre');
    }
